...
public class ItemsDirectToDatabase implements CommandLineRunner {
    ...
    // I believe this changes the run method in the main application so that everytime you start the program this is run
    @Override
    public void run(String... args) throws Exception {
        ...
        System.out.println("Deleted 112 itemCode from DATABASE");
